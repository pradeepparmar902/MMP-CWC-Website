        ...
        {view === 'profile' && (
           <div className="profile-settings-view">
              <div className="profile-info-card">
                 ...
                 {fullProfileData ? (
                   Object.keys(fullProfileData).filter(k => k !== 'membershipNo' && fullProfileData[k]).length > 0 ? (
                     Object.keys(fullProfileData).map(key => {
                     ...
                     <div className="profile-info-row">
                       <span className="info-label">Additional Data</span>
                       <span className="info-value" style={{ opacity: 0.5, fontStyle: 'italic', fontSize: '12px' }}>
                         No registration data found for this account.
                       </span>
                     </div>
                   )
                 ) : (
